...
namespace Booking
{
    public class XmlHåndterer
    {
        public void leggTilNyGjest(string gjesteNavn, DateTime innsjekkDato, DateTime utsjekkDato)
        {
            try
            {
                XDocument doc = XDocument.Load("C:/Users/Thor-Arne/Documents/Visual Studio 2013/Projects/hotell/Booking/XML/nyGjest.XML");
                doc.Root.Add(
                    new XElement("gjest",
                ...
                doc.Save("C:/Users/Thor-Arne/Documents/Visual Studio 2013/Projects/hotell/Booking/XML/nyGjest.XML");               
            }
            catch (Exception f)
            {
